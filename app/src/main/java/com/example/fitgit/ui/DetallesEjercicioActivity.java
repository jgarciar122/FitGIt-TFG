...
public class DetallesEjercicioActivity extends AppCompatActivity {
    ...
    private void cargarDatos(Ejercicio ejercicio) {
        ...
        binding.chipDetalleMusculo.setText(
                com.example.fitgit.util.TraductorLocal.traducirParteCuerpo(ejercicio.getParteCuerpo()));
        binding.chipDetalleEquipo.setText(
                com.example.fitgit.util.TraductorLocal.traducirEquipamiento(ejercicio.getEquipamiento()));
