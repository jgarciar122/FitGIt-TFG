...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // esto conecta el bottom nav con el navigation component
        NavigationUI.setupWithNavController(binding.navegacionInferior, navController);

        // sobreescribo el listener para que siempre vuelva al inicio del grafo al cambiar de tab
        ...
        binding.navegacionInferior.setOnItemReselectedListener(item -> {
            if (navController.getCurrentDestination() != null
                ...
                // si estamos en perfil u otra pantalla fuera del bottom nav, volvemos al tab
                navController.navigate(item.getItemId(), null, new NavOptions.Builder()
                        .setLaunchSingleTop(true)
                        .setPopUpTo(navController.getGraph().getStartDestinationId(), false)
                        .build());
            } else {
                // si ya estamos en ese tab, volvemos a la raiz del fragment
